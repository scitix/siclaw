...
| `skill_preview` | `skill-preview.ts` | Read skill draft files from disk, return structured preview for side panel with copy buttons. Cleans up draft directory after reading |
