...
Upgrade both SiCore and SiClaw. Old events without context remain accepted, but
trace continuity is not guaranteed and existing records are not merged. This
covers the web handoff loop: the SiCore `/run` and A2A handlers do not yet drive
