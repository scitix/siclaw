...
8. **Skill preview in conversation**: the `skill_preview` tool generates structured skill content (SKILL.md + scripts) as an inline card with copy buttons. It does not persist anything — users copy content to the Skills UI manually.
