...
SiCore copies scalars, never modifies shared event maps, and retains the first
...
SiCore HTTP/WS/DB operations are not all instrumented by this propagation change.
