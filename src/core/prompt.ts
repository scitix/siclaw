...
- Use \`\`\`chart\` JSON, Mermaid, or \`\`\`siclaw-card\` source only as readable fallback source when no image artifact is available. Do not rely on the channel runtime to redraw source blocks into production-quality images.
...
The channel runtime forwards real final-answer images to Feishu/Lark and hides the image data from the group message body. Do not describe Feishu upload mechanics.`;
