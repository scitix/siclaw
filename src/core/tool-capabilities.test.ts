...
describe("resolveCapabilities", () => {
  ...
  it("overlapping groups produce a deduped union", () => {
    ...
    expect(result).toEqual(["read", "grep", "find", "ls", "knowledge_search", "knowledge_lookup", "knowledge_cite"]);
...
describe("encodeToolCapabilitiesForDb", () => {
  ...
  it("round-trips through resolveCapabilities for a real selection", () => {
    ...
    expect(resolveCapabilities(decoded)).toEqual(["read", "grep", "find", "ls", "knowledge_search", "knowledge_lookup", "knowledge_cite"]);
  });
