import { SENSITIVE_KEY_PATTERNS, redactDataDocument } from "../tools/infra/kubectl-sanitize.js";
...
export function sanitizeSandboxResult(value: unknown, depth = 0): unknown {
  ...
  if (typeof value === "string") return sanitizeOutput(redactDataDocument(value).text);
