...
import { CredentialDrawer } from '../../Credentials/components/CredentialDrawer';
import type { Credential, CredentialType } from '../../Credentials/credentialData';
import { CREDENTIAL_TYPE_LABELS, CREDENTIAL_TYPE_OPTIONS } from '../../Credentials/credentialData';
...
export function CredentialsSection({ sendRpc, isConnected }: CredentialsSectionProps) {
