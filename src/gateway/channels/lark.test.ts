...
describe("handleLarkMessage — streaming card flow", () => {
  ...
  it("keeps Mermaid flowcharts visible when no PNG artifact is available", async () => {
    resolveBindingMock.mockResolvedValue({ agentId: "a1", bindingId: "b" });
  ...
  it("keeps Siclaw conclusion cards visible when no PNG artifact is available", async () => {
    resolveBindingMock.mockResolvedValue({ agentId: "a1", bindingId: "b" });
