...
export const AGENT_TYPES: AgentTypeOption[] = [
  {
    ...
    capabilities: ["inspect_infra", "run_commands", "run_scripts", "run_sandbox", "read_files", "write_sandbox", "search_memory", "manage_memory", "plan_tasks", "spawn_subagents", "session_output", "transfer_conversation"],
