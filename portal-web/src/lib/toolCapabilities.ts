...
export const CAPABILITY_GROUPS: CapabilityGroup[] = [
  ...
  { key: "manage_memory", name: "Manage memory", description: "Record explicit user requests to remember, correct or forget; report source usefulness", tools: ["memory_update", "memory_feedback"] },
  { key: "search_memory", name: "Search memory", description: "Search and read authorized historical evidence", tools: ["memory_search", "memory_get", "memory_catalog"] },
