...
export const CAPABILITY_GROUPS: CapabilityGroup[] = [
  ...
  { key: "run_commands", name: "Run commands", description: "Execute whitelisted shell commands (kubectl read-only)", tools: ["bash", "node_exec", "pod_exec", "host_exec", "k8s_inspect", "tool_output"] },
  { key: "run_scripts", name: "Run scripts", description: "Execute scripts on node / pod / host", tools: ["node_script", "pod_script", "local_script", "host_script", "tool_output"] },
